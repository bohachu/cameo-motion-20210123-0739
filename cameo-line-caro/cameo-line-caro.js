...
class CameoLine extends HTMLElement {
  ...
  parse_ary_chart_data(ary_data) {
    let i = 0;
    let j = ary_data[0].length - 1;
    let ary_chart_data = [];
    for (; i < j; i++) {
      let dic_data = {};
      dic_data["year"] = ary_data[0][i];
      dic_data[ary_data[1][j]] = parseFloat(ary_data[1][i]);
      dic_data[ary_data[2][j]] = parseFloat(ary_data[2][i]);
      dic_data[ary_data[3][j]] = parseFloat(ary_data[3][i]);
      dic_data[ary_data[4][j]] = parseFloat(ary_data[4][i]);
      dic_data[ary_data[5][j]] = parseFloat(ary_data[5][i]);
      dic_data[ary_data[6][j]] = parseFloat(ary_data[6][i]);
      dic_data[ary_data[7][j]] = parseFloat(ary_data[7][i]);
      dic_data[ary_data[8][j]] = parseFloat(ary_data[8][i]);
      dic_data[ary_data[9][j]] = parseFloat(ary_data[9][i]);
      dic_data[ary_data[10][j]] = parseFloat(ary_data[10][i]);
